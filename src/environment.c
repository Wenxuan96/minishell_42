...
/*   Updated: 2025/04/03 16:12:59 by wxi              ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	t_environment	**env_list_current;

	env_list_current = env_list;
	while ((*env_list_current) != NULL)
	{
		printf("var : %s\n", (*env_list_current)->env_var);
		printf("val : %s\n", (*env_list_current)->value);
		env_list_current = &(*env_list_current)->next_env_var;
	}
